...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays(songplay_id int PRIMARY KEY, start_time date NOT NULL, user_id int NOT NULL, level int, song_id varchar, artist_id int, session_id int, location varchar, user_agent varchar)
""")
